## Text Classification
### `import "github.com/TranDuyThanh/goml/text"`

[![GoDoc](https://godoc.org/github.com/TranDuyThanh/goml/text?status.svg)](https://godoc.org/github.com/TranDuyThanh/goml/text)
